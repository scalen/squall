 ...
 *
 */
public class CombinedSourceTPLOOrchestrator extends TPLOOrchestrator {
	 ...
	 * @param time
	 */
	public CombinedSourceTPLOOrchestrator(int capacity, long duration, TimeUnit time) {
	 ...
	 * 
	 */
	public CombinedSourceTPLOOrchestrator() {
		super();
	}
